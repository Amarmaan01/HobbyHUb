                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden sm:ml-8 sm:flex sm:space-x-6">
                            <?php if (isLoggedIn()): ?>
                                ...
                                <a href="logout.php" class="nav-link inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-700 hover:text-indigo-600 <?php echo ($current_page == 'logout.php') ? 'active' : ''; ?>">
                                    <svg class="mr-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                    </svg>
                                    Logout
                            ...
                            <?php else: ?>
                                ...
                                <a href="#" class="nav-link inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-700 hover:text-indigo-600 <?php echo ($current_page == 'features.php') ? 'active' : ''; ?>">
                                    <svg class="mr-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                                    </svg>
                                    Features
                                </a>
                                <a href="#" class="nav-link inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-700 hover:text-indigo-600 <?php echo ($current_page == 'about.php') ? 'active' : ''; ?>">
                                    <svg class="mr-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div>
                                    <button type="button" class="user-menu-button flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <span class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-indigo-100 hover:bg-indigo-200">
                                            <span class="text-sm font-medium leading-none text-indigo-700">JD</span>
                                        </span>
                                    </button>
                                </div>
                                <!-- User dropdown menu -->
    ...
    <script>
        ...
        if (closeBanner && announcementBanner) {
            closeBanner.addEventListener('click', () => {
                ...
                // Remove the banner from DOM after transition completes
